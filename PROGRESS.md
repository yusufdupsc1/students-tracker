...
- [ ] 8. Student Search
- [ ] 9. Unit tests for `src/lib/calculations.ts` (trap #1 coverage)
- [ ] 10. Import-from-xlsx wiring (`importXlsx.js` exists but is dead/unwired)
- [ ] 11. Lighthouse PWA + offline verification
- [ ] 12. Dead-code cleanup: remove unwired JS prototype (`src/screens/`, `src/context/`, `src/db/db.js`, `src/lib/{calc,gradeScale,importXlsx,qr}.js`, `src/components/Layout.jsx`, `src/styles/*`, `calc.test.js`)
